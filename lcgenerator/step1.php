        ...
        <!-- Page Content -->
          ...
          <div class="form-group">
            <div class="form-label-group">
              ...
              <label for="inputEmail">Caste & Sub Caste </label>
            </div>
          </div>
               ...
               <div class="form-group">
                <div class="form-row">
                     ...
                     <h6 class="text-primary">Nationality : </h6> 
                   </div>
                   <div class="col-md-2 left">
                       <input type="radio" name="gen" value="Male" <?php if ($gender == "Male") echo "checked"; ?>>Indian
                     </div>
                     <div class="col-md-2">
                      <input type="radio" name="gen" value="Female" <?php if ($gender == "Female") echo "checked"; ?>>Other
                  </div>
                </div>
              </div>
             <div class="form-group fix">
                ...
                <div class="form-row">
                   ...
                   <div class="col-md-5 left">
                        <select name="city" class="form-control">
                          ...
                          <option value="Computer" <?php if ($ct=="Computer") {
                            echo "selected";
                          } ?>>Computer</option>
              ...
              <div class="form-group fix">
                ...
                <div class="form-row">
                      <div class="col-md-2 left"> 
                     <h6 class="text-primary">Addimission : </h6> 
                   </div>
                   <div class="col-md-5 left">

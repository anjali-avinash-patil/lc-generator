                ...
                <div class="form-row">
                    ...
                    <!-- <div class="form-label-group"> -->
                     ...
                     <div class="left col-md-5" >
                            ...
                            <input type="checkbox" name="hby[]" value="Reading"> School
                            </div>
                             <div class="form-control">   
                            <input type="checkbox" name="hby[]" value="Dancing"> Diploma
                            </div>
                            <div class="form-control"> 
                            <input type="checkbox" name="hby[]" value="Singing"> Engineering
                             </div>
                             <div class="form-control"> 
                            <input type="checkbox" name="hby[]" value="Travelling"> Pharmacy
                         </div>
                       </div>

...
<?php 
 ...
 session_start();
  ...
  $pdf->Image('Images/Header.png',6,2,200,60);
	$pdf->Ln(52);
	...
	$pdf->Cell(50,10,"Mother Name",1);
	$pdf->Cell(0,10,$ln,1,1);

	$pdf->Cell(50,10,"Caste & Sub Caste  ",1);
	$pdf->Cell(0,10,$ml,1,1);

	$pdf->Cell(50,10,"Nationality",1);
	...
	$pdf->SetFont("Arial","",22);
	$pdf->SetTextColor(255,255,255);
	$pdf->Cell(0,10,"Addimission DETAILS",1,1,'C',true);
	$pdf->SetFont("Arial","",14);
	$pdf->SetTextColor(1,1,1);
	$pdf->Cell(63.33,10,"Addimission Date ",1);
	$pdf->Cell(63.33,10,"Leaving Date",1);
	$pdf->Cell(63.33,10,"DIPLOMA",1,1);
	...
	$pdf->SetFont("Arial","",14);
	$pdf->SetTextColor(1,1,1);
	$pdf->Cell(63.33,10,"Date Of Birth",1);
	$pdf->Cell(63.33,10,"Place Of Birth",1);
	$pdf->Cell(63.33,10,"Progress In Studies",1,1);
	...
	$pdf->SetFont("Arial","",14);
	$pdf->SetTextColor(1,1,1);	
	$pdf->Cell(63.33,10,"Last School Attended",1);
	$pdf->Cell(63.33,10,"Reason Of Leaving Collage",1);
	$pdf->Cell(63.33,10,"Remark",1,1);

...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    <a class="navbar-brand mr-1" href="index.php">LC Generator</a>
             ...
             <h2 align="center">Education Details</h2>
                ...
                <form  action="step2process.php" method="get">
                  <div>
                    <div class="form-row">
                     ...
                     <lable class="title1 text-primary">Year</lable>
                      ...
                      <div class="col-md-3 text-center">
                      <lable class="title1 text-primary"> Marks</lable>
                    </div>
                  ...
                  <div>
                      <div class="form-row">
                      <div class="col-md-3"> 
                     <input type="text" name="course1" placeholder="First Year" class="txt1 form-control" value="<?php echo $course1; ?>">
                     </div>
                     <div class="col-md-3">
                    <input type="text" name="year1" placeholder="Mark" class="txt1 form-control" value="<?php   echo $year1; ?>">
                     </div>
                  ...
                  <div>
                     <div class="form-row">
                      <div class="col-md-3"> 
                    <input type="text" name="course2" class="txt1 form-control" placeholder="Second Year " value="<?php echo $course2; ?>">
                      </div>
                      <div class="col-md-3"> 
                    <input type="text" name="year2" class="txt1 form-control" placeholder="Mark" value="<?php echo $year2; ?>">
                      </div>
                  ...
                  <div>
                     <div class="form-row">
                      <div class="col-md-3"> 
                      <input type="text" name="course3" class="txt1 form-control" placeholder="Third Year" value="<?php echo $course3; ?>">
                      </div>
                       <div class="col-md-3"> 
                       <input type="text" name="year3" class="txt1 form-control" placeholder="Mark" value="<?php echo $year3; ?>">
                     </div>
                  ...
                  <div>
                    <div class="form-row">
                      <div class="col-md-3"> 
                    <input type="text" name="course4" class="txt1 form-control" placeholder="CGPA" value="<?php echo $course4; ?>">
                  </div>
                  <div class="col-md-3">
                    <input type="text" name="year4" class="txt1 form-control" placeholder="%" value="<?php echo $year4; ?>">
                  </div>
                  ...
                  <br>
                  <hr><hr>
                  <h2 align="center">Addimission & Leaving Status</h2>
                  <hr><hr>
                  <div>
                    <div class="form-row">
                    <div class="col-md-4 text-center">
                    <lable class="title2 text-primary">Addimission Date</lable>
                    </div>
                    <div class="col-md-4 text-center">
                    <lable class="title2 text-primary">Leaving Date </lable>
                  </div>
                  ...
                  <div>
                    <div class="form-row">
                      <div class="col-md-4">
                    <input type="text" name="title2" class="txt2 form-control" placeholder="DD-MM-YYYY " value="<?php echo $title2; ?>">
                  </div>
                  <div class="col-md-4">
                    <input type="text" name="ayear2" class="txt2 form-control" placeholder="DD-MM-YYYY" value="<?php echo$ayear2 ?>">
                  </div>
      ...
      <footer class="sticky-footer">
        <div class="container my-auto fix">
          <div class="copyright text-center my-auto">
            <span>Loknete Hon. Hanmantrao Patil Charitable Trusts ADARSH COLLEGE, VITA</span>
          </div>
        </div>
      </footer>

            ...
            <h2 align="center">Experience Details</h2>
                ...
                <form  action="step3process.php" method="get">
                  <div>
                    ...
                    <lable class="title2 text-primary">Date Of Birth</lable>
                  </div>
                  <div class="col-md-4 text-center">
                    <lable class="title2 text-primary">Place Of Birth</lable>
                  </div>
                  <div class="col-md-4 text-center">
                    <lable class="title2 text-primary">Progress In studies</lable>
                  </div>
                  </div>
                  </div>
                  <br>
                  ...
                  <div>
                    <div class="form-row">
                      <div class="col-md-4 text-center">
                    <lable class="title2 text-primary">Last Attended School</lable>
                  </div>
                  <div class="col-md-4 text-center">
                    <lable class="title2 text-primary">Reason Of Leaving Collage </lable>
                  </div>
                  <div class="col-md-4 text-center">
                    <lable class="title2 text-primary">Remark</lable>
                  </div>
                  </div>
                  </div>
                  <br>
